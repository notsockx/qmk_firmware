...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[main] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, KC_DEL,  MO(alt1),KC_BSPC, KC_SPC,  MO(alt2),KC_LBRC, KC_RBRC, KC_MINS, KC_EQL  
    ),
	[qwer] = LAYOUT(
    ...
    [alt2] = LAYOUT(
        ...
        _______, _______, _______, TG(qwer),XXXXXXX, XXXXXXX, XXXXXXX, MO(alt2),_______, _______, _______, _______
    )
};
